...
├── logout.php              # Logout
├── api_estagios.php        # API: Listar estágios
├── cadastro.php            # API: Criar novo estágio
├── editar.php              # API: Atualizar estágio
├── excluir.php             # API: Deletar estágio
...
#### 2. **Listar Estágios**
```
GET /api_estagios.php
GET /api_estagios.php?status=em_andamento
GET /api_estagios.php?busca=Pedro
